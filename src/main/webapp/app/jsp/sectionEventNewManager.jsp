 		...
 		<article id="event-form" class="list indented scroll active">
        	<ul class="form">
        		<li class="dark"><span data-lnt-id="event.newCabText"></span> <span id="event_hour"></span></li>
              	<li>
              		<label id="error_eveTime" style="color:red;"></label> <label data-lnt-id="event.hour"></label>:
               		<input id="eveTime" size="5" type="time" pattern="(0[0-9]|1[0-9]|2[0-3])(:[0-5][0-9])" required>
              	</li>
       		   	<li>
	   				<label data-lnt-id="event.new"></label>:
	   				<label class="select">
     					<select id="eveClientNew" class="custom">
       			...
       			<li id="searchLi" style="display: none;">
       				<label data-lnt-id="form.search"/></label>
       				<a href="#" class="button" data-action="search-client" data-icon="search"></a>
       			</li>
              	<li data-icon="user">
   	        			<label id="error_eveClientName" style="color:red;"></label> <label data-lnt-id="client.name"></label>:
	        			<input type="search" data-lnt-id="client.name" placeholder="" id="eveClientName" autocomplete required/>
	          	
	        			<label id="error_eveClientEmail" style="color:red;"></label> <label data-lnt-id="client.email"></label>:
	        			<input type="email" data-lnt-id="client.email" placeholder="" id="eveClientEmail" autocomplete />
