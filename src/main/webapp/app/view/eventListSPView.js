...
(function() {
  ...
  __View.EventListSPView = (function(superClass) {
    extend(EventListSPView, superClass);

    function EventListSPView() {
      return EventListSPView.__super__.constructor.apply(this, arguments);
    }

    EventListSPView.prototype.container = "section#booking article#list-events ul";

    EventListSPView.prototype.template_url = "/app/templates/eventsListSP.mustache";

    EventListSPView.prototype.elements = {
      "div:first-child": "divConsumed"
    };

    EventListSPView.prototype.events = {
    ...
    EventListSPView.prototype.consumEventConfirm = function(event) {
      var _this, data, url;
    ...
    EventListSPView.prototype.showConsumEvent = function(response) {
      var consumed;
      consumed = false;
      if (response === 1) {
        consumed = true;
