...
public class LocalTaskMapper {
	
	public LocalTaskMapper() {

	}	
	
	public LocalTask map(LocalTaskDTO task){
	...
	public LocalTaskDTO map(LocalTask entityLocalTask) {
	...
	public LocalTaskDTO map(Entity entityLocalTask) {
